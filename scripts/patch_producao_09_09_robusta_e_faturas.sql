-- ============================================================
-- PROJETO   : CIP - Monitor de Energia (PRODUÇÃO)
-- SCRIPT    : patch_producao_09_09_robusta_e_faturas.sql
-- DATA      : 2026-09-09
-- OBJETIVO  : 1. Adicionar colunas de robustez na tabela 'controladores'
--                (tipo_ligacao, custo_disponibilidade_kwh, delta_max_kwh)
--             2. Criar tabela 'faturas_distribuidora' para conciliação
-- ============================================================

-- 1. Alteração da tabela controladores
-- Adiciona colunas para configuração da instalação e proteção anti-glitch
...
-- 2. Criação da tabela faturas_distribuidora (se ainda não existir em produção)
...
-- DESCRIBE faturas_distribuidora;
