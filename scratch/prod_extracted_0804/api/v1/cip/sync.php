...
require_once __DIR__ . '/../../app/services/LimitesSync.php'; // Adicionado para gerar o hash
...
if ($method === 'POST') {
    ...
    try {
        ...
        // Calcula o hash da curva para salvar no banco
        $hashCalc = LimitesSync::calcularHash($payload);
        ...
        // Insere nova linha informando atualizado_em e o hash_payload
        $stmtInsert = $pdo->prepare("INSERT INTO tabela_limites (controlador_id, versao, payload_json, hash_payload, atualizado_em, origem, usuario_id, sync_status, ativa) VALUES (:cid, :v, :p, :h, CURRENT_TIMESTAMP, 'cloud', :u, 'pendente_ack', 1)");
        $stmtInsert->execute([
            ':cid' => $controlador_id,
            ':v' => $nova_versao,
