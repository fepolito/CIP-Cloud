 ...
 * @objetivo      Dashboard de monitoramento de energia (KPIs + ├íreas reservadas para infogr├ífico SVG e cards instant├óneos)
 * @autor         Fernando / CIP Cloud Copilot / ATGY
 *
 * Depend├¬ncias de hardware:
 *   - Servidor com MySQL/MariaDB acess├¡vel via localhost:3306
 *   - Navegador com suporte a HTML5, CSS3 e JavaScript ES6+
 *
 * Depend├¬ncias de software/arquivos:
 *   - config/app.php
 *   - config/database.php   ÔåÆ factory getDbConnection()
 *   - app/auth.php
 ...
 *
 * Hist├│rico de implementa├º├Áes:
 *   2026-04-07  v1.0     Implementa├º├úo inicial com ApexCharts
 *   2026-04-07  v1.1     verify.php no boot + logout com invalida├º├úo
 *   2026-04-08  v1.2     Migra├º├úo JWT ÔåÆ sess├úo PHP
 *   2026-04-08  v1.3     Migra├º├úo para app_header.php global
 *   2026-04-08  v1.4     requireAuth() do app/auth.php
 *   2026-04-08  v1.5     Remo├º├úo app-shell.js duplicado
 *   2026-04-11  v1.6     <head> refatorado: usa app_head.php
 *   2026-04-11  v1.7     Restaura├º├úo completa do <style> interno
 *   2026-04-15  v1.8     [FIX] Adicionado require database.php +
 *                        $pdo = getDbConnection() ÔÇö aus├¬ncia causava
 *                        Fatal Error no app_header.php (query logo)
 *                        Corrigido $appPaginaAtual 'inicio' ÔåÆ 'dashboard'
 ...
 *   2026-07-09  v1.13.1  Fix anima├º├úo: classes de estado inv├ílidas (prefixo --) e
 *                        aus├¬ncia de regra CSS de fluxo ativo. Setas agora animam.
 *   2026-07-09  v1.13.2  Fix stroke-dasharray para loop matem├ítico perfeito no fluxo SVG.
 *   2026-07-09  v1.13.3  Reduz fator de c├ílculo da velocidade da anima├º├úo do fluxo no JS.
 *   2026-07-09  v1.13.4  Ajuste do filtro SVG glow para userSpaceOnUse e simplifica├º├úo 
 *                        da anima├º├úo reversa com animation-direction.
 *   2026-07-09  v1.13.5  Revers├úo da anima├º├úo da exportada para @keyframes expl├¡cito
 *                        (fluxo-mover-exportada) com stroke-dashoffset 36.
 *   2026-07-09  v1.13.6  Ajuste de sinal do stroke-dashoffset (para negativo) no
 *                        fluxo exportado a pedido, alinhando com a orienta├º├úo real do path.
 *   2026-07-12  v1.14.1  [FIX] Remo├º├úo do card solto de Frequ├¬ncia (#kFreq)
 *                        redundante ÔÇö dado j├í exibido no rodap├® do
 *                        infogr├ífico (#infoFreq). Removido HTML .kpi-grid
 *                        ├│rf├úo + binding JS em carregarKpis(). CSS .kpi*
 ...
 *   2026-07-15  v1.15.1  Fix stacking: cards ficavam atr├ís do infografico (z-index:-1 furava). isolation:isolate + z-index positivo.
 * ============================================================
 */
...
$appUsuarioNome  = $_SESSION['usuario_nome']  ?? 'Usu├írio';
...
<head>
  ...
  <style>
    ...
    /* ÔöÇÔöÇ TEMA CLARO ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    ...
    /* ÔöÇÔöÇ Reset ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* ÔöÇÔöÇ Wrapper ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    .wrap {
      max-width: 1440px;
      margin: 0 auto;
    ...
    /* ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
       TOOLBAR (simplificada ÔÇö sem botoes de periodo)
    ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ */
    .toolbar {
      display: flex;
      align-items: center;
    ...
    /* ÔöÇÔöÇ Status pill (Online/Offline) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    .kpi-status-pill {
      display: inline-flex;
      align-items: center;
      gap: 8px;
    ...
    /* ===== Infogr├ífico como background decorativo ===== */
    #infografico-host {
      position: sticky;          /* fica preso no topo enquanto rola */
      top: 0;
      z-index: 0;
      opacity: 1;                /* come├ºa V├ìVIDO (era 0.15) */
      transform-origin: center top;
      will-change: opacity, transform;
      transition: opacity .15s linear;
      pointer-events: none;      /* n├úo bloqueia cliques nos cards */
    }
    ...
    #cards-host {
      ...
      margin-top: 40vh;          /* empurra os cards p/ baixo -> diagrama aparece 1┬║ */
    }
    ...
    /* grid: ├¡cone | label | barra (flex├¡vel) | valor */
    .cb-linha {
      display: grid;
    ...
    /* ÔöÇÔöÇ Palco SVG ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    .infografico-palco {
      width: 100%;
      position: relative;
    }
    ...
    /* ÔöÇÔöÇ NOS (caixas) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    .no-caixa {
      fill: var(--bg);
      stroke: var(--border);
      stroke-width: 1.5;
    ...
    /* ÔöÇÔöÇ FLUXOS (caminhos) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    .fluxo-trilho {
      fill: none;
      stroke: var(--border);
      stroke-width: 6;
    ...
    /* ÔöÇÔöÇ Rodape ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    .infografico-rodape {
      display: flex;
      align-items: center;
      justify-content: center;
    ...
    /* ÔöÇÔöÇ SEMAFORO DE SAUDE (Fase 2) ÔöÇÔöÇ */
    .semaforo {
...
<!-- ÔöÇÔöÇ Loading overlay ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ -->
<div id="loading">
  <div class="spin"></div>
  <p>VERIFICANDO SESS├âO...</p>
</div>

<!-- ÔöÇÔöÇ Cabe├ºalho global ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ -->
<?php require __DIR__ . '/includes/app_header.php'; ?>

<!-- ÔöÇÔöÇ Conte├║do principal ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ -->
<div class="wrap">
  ...
  <div class="toolbar">
    <div class="ctrl-info">
      ...
      <?php if (empty($controladoresAcessiveis)): ?>
        <div class="nome">Nenhum controlador dispon├¡vel, contate o administrador</div>
        ...
        <select id="sel-controlador-main" class="sel-ctrl" onchange="trocarControlador(this.value)" style="background: transparent; border: 1px solid var(--border); color: var(--txt); padding: 8px 12px; border-radius: 8px; font-size: 14px; width: 100%; margin-top: 6px; outline: none; appearance: auto;">
          ...
          <?php foreach ($controladoresAcessiveis as $c): ?>
            <option value="<?= $c['id'] ?>" style="background: var(--card); color: var(--txt);">
              ...
              <?= $c['apelido'] ? ' ÔÇö ' . htmlspecialchars($c['apelido']) : '' ?>
            </option>
          <?php endforeach; ?>
        </select>
      <?php else: ?>
    ...
    <span class="refresh-info" id="refreshInfo">ÔÅ▒ ÔÇö</span>
  </div>

  <!-- ÔöÇÔöÇ SEM├üFORO DE SA├ÜDE DA INSTALA├ç├âO ÔöÇÔöÇ -->
  <div class="semaforo" id="semaforo" style="display: none;">
    <div class="semaforo-luz cinza" id="semLuz"></div>
    <div class="semaforo-info">
      <strong id="semTitulo">ÔÜ¬ Verificando status...</strong>
  ...
  <div id="infografico-host" class="infografico-wrap">
    ...
    <div class="infografico-head">
      <div class="infografico-titulo">
        ­ƒîÉ Fluxo Energetico em Tempo Real
      </div>
      <div class="infografico-meta">
        <span class="infografico-idade" id="infoIdade">ÔÇö sem dados ÔÇö</span>
    ...
    <div class="infografico-palco">
      <svg viewBox="0 0 1000 480" preserveAspectRatio="xMidYMid meet"
        ...
        <g class="no-grupo" transform="translate(420, 30)">
          ...
          <text class="no-emoji"  x="80" y="38" text-anchor="middle">ÔÿÇ´©Å</text>
        ...
        <g class="no-grupo" transform="translate(40, 250)">
          ...
          <text class="no-emoji"  x="80" y="38" text-anchor="middle">ÔÜí</text>
        ...
        <g class="no-grupo" transform="translate(400, 230)">
          ...
          <text class="no-emoji"  x="100" y="42" text-anchor="middle">­ƒÅá</text>
        ...
        <g class="no-grupo standby" transform="translate(800, 245)">
          ...
          <text class="no-emoji"  x="80" y="38" text-anchor="middle">­ƒöï</text>
      ...
      <div class="infografico-rodape">
        <span class="info-mini" title="Tensao da rede">
          ­ƒöî <strong id="infoTensao">ÔÇö V</strong>
        </span>
        <span class="info-mini" title="Frequencia da rede">
          ÒÇ░´©Å <strong id="infoFreq">ÔÇö Hz</strong>
        </span>
        <span class="info-mini" title="Status do inversor">
          ÔÜÖ´©Å <strong id="infoInversor">ÔÇö</strong>
        </span>
        <span class="info-mini" title="Limite de exportacao ativo">
          ­ƒÜª <strong id="infoLimite">ÔÇö</strong>
        </span>
      </div>
    </div>
  ...
  <div id="cards-host">
    <div class="card-energia card-barras">
      <h3 class="cb-titulo">ÔÜí Balan├ºo Energ├®tico <small>(kWh)</small></h3>

      <div class="cb-linha" data-metrica="geracao">
        <span class="cb-icone">ÔÿÇ´©Å</span>
        <span class="cb-label">Gera├º├úo
  ...
  <div class="kpi-grid" style="grid-template-columns:repeat(3,1fr);margin-bottom:20px;">
    <div class="kpi" style="--kc:var(--green)">
      ...
      <div class="kpi-sub" id="tPing">├Ültimo ping: ÔÇö</div>
      <div class="kpi-icon">­ƒôí</div>
    </div>
    <div class="kpi" style="--kc:var(--blue2)">
      <div class="kpi-lbl">Localiza├º├úo</div>
      <div class="kpi-val" style="font-size:14px;line-height:1.4" id="tLoc">ÔÇö</div>
      <div class="kpi-icon">­ƒôì</div>
    </div>
    <div class="kpi" style="--kc:var(--txt-mid)">
      <div class="kpi-lbl">Controlador</div>
      <div class="kpi-val" style="font-size:14px;line-height:1.4" id="nomeCtrlKpi">ÔÇö</div>
      <div class="kpi-icon">­ƒûÑ´©Å</div>
    </div>
  </div>
...
<footer class="footer">
  CIP ÔÇö Controlador de Inje├º├úo de Pot├¬ncia El├®trica &nbsp;|&nbsp;
  Aeonium &nbsp;|&nbsp; S├úo Paulo, BR &nbsp;|&nbsp; v1.15.1
</footer>
...
const fmt = (v, d, u) => v != null ? `${(+v).toFixed(d)} ${u}`.trim() : 'ÔÇö';
...
async function verificarToken() {
  try {
    ...
    if (data.segundos_restantes < 1800)
      console.warn(`[CIP] Sess├úo expira em ${data.segundos_restantes}s`);
    return true;
  } catch (e) {
    console.warn('[CIP] verify.php inacess├¡vel ÔÇö modo offline');
    return true;
  }
}
...
function renderSemaforo() {
  ...
  if (idade >= OFFLINE_S)      { icone='­ƒö┤'; tituloTxt='Sem comunica├º├úo'; classe='sem-off'; }
  else if (idade >= STALE_S)   { icone='­ƒƒí'; tituloTxt='Dados atrasados'; classe='sem-stale'; }
  else if (!houveFluxo)        { icone='­ƒîÖ'; tituloTxt='Usina em repouso'; classe='sem-idle'; }
  else                         { icone='­ƒƒó'; tituloTxt='Usina ativa';      classe='sem-on'; }
  ...
  if (sub) {
    if (idade >= OFFLINE_S) sub.textContent = `Offline h├í mais de ${Math.floor(idade/60)} min`;
    else if (idade >= STALE_S) sub.textContent = `Atraso de ${Math.floor(idade/60)} min`;
    else if (!houveFluxo) sub.textContent = 'Sem fluxo ou gera├º├úo';
...
/** * carregarKpis() ÔÇö versao simplificada do antigo carregar()
...
async function carregarKpis() {
  ...
  try {
    ...
    if (controlador) {
      ...
      document.getElementById('tLoc').textContent        = controlador.localizacao || 'ÔÇö';

      const pingStr = controlador.ultimo_ping
        ? new Date(controlador.ultimo_ping).toLocaleString('pt-BR') : 'ÔÇö';
      document.getElementById('tPing').textContent = `├Ültimo ping: ${pingStr}`;
    ...
    document.getElementById('refreshInfo').textContent =
      'ÔÅ▒ ' + new Date().toLocaleTimeString('pt-BR') + ' ┬À auto 10s';
    document.getElementById('loading').style.display = 'none';

  } catch (err) {
    console.error('[CIP] Erro ao carregar KPIs:', err);
    document.getElementById('refreshInfo').textContent = 'ÔÜá´©Å Falha na ├║ltima atualiza├º├úo';
    document.getElementById('loading').style.display   = 'none';
  }
}
...
// ÔöÇÔöÇ Reatividade de tema (apenas atualiza cache de cores) ÔöÇÔöÇÔöÇÔöÇÔöÇ
...
verificarToken()
  ...
  .catch(err => {
    console.error('[CIP] Falha na verifica├º├úo de sess├úo:', err);
    const l = document.getElementById('loading');
    if (l) l.innerHTML = '<p>Erro ao verificar sess├úo. <a href="/login.php">Recarregar</a></p>';
  });
</script>
  ...
  <!-- ÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉÔòÉ
       JAVASCRIPT DO INFOGRAFICO (B2.2 Parte 3/3 ÔÇö v1.12.0)
  ...
  (function(){
    ...
    /* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Configuracao ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    const CFG = {
      ...
      alertaIdadeS:    360,     // 6min ÔÇö uma janela perdida
      criticoIdadeS:   660,     // 11min ÔÇö duas janelas perdidas
      maxRetries:      3,       // tentativas em caso de erro
      debug: new URLSearchParams(location.search).get('debug') === '1'
    };

    /* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Log condicional ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    const log = (...a) => CFG.debug && console.log('[CIP-Info]', ...a);
    const warn = (...a) => console.warn('[CIP-Info]', ...a);

    /* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ ID do controlador ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    ...
    if (!controladorId) {
      warn('controlador_id nao identificado ÔÇö infografico desativado');
      return;
    }
    log('controlador_id =', controladorId);

    /* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Cache de refs DOM ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    ...
    /* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Estado ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    const state = {
      ultimoTsUtc:     null,
      ultimoFetchOk:   null,
      tentativasFalha: 0,
    ...
    /* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Helpers de formatacao ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    function fmtKwOuND(watts, casas = 2) {
      if (watts === null || watts === undefined) {
        return 'N/D <tspan class="aviso-integracao"><title>Aguardando integra├º├úo com inversor solar. Gera├º├úo ser├í exibida quando o firmware conectar ao Solis.</title>Ôôÿ</tspan>';
      }
      if (isNaN(watts)) return 'ÔÇö kW';
      const kw = Number(watts) / 1000;
      return kw.toFixed(casas) + ' kW';
    }

    function fmtKwComSinal(watts, modo, casas = 2) {
      if (watts == null || isNaN(watts)) return 'ÔÇö kW';
      const kw = Number(watts) / 1000;
      
      let prefix = '';
      if (modo === 'consumo' && kw > 0) prefix = 'ÔêÆ';
      else if (modo === 'injecao' && kw > 0) prefix = '+';
      else if (modo === 'saldo') {
        if (kw > 0) prefix = '+';
        else if (kw < 0) prefix = 'ÔêÆ';
      }
    ...
    function fmtNum(v, sufixo = '', casas = 2) {
      if (v == null || isNaN(v)) return 'ÔÇö' + (sufixo ? ' ' + sufixo : '');
      return Number(v).toFixed(casas) + (sufixo ? ' ' + sufixo : '');
    }
    function fmtIdade(segs) {
      if (segs == null) return 'ÔÇö sem dados ÔÇö';
    ...
    function fmtKwh(valor, aviso) {
      if (aviso === 'aguardando_dados_suficientes') {
        return `ÔÇö <tspan style="cursor:help;"><title>aguardando dados do dia</title>Ôôÿ</tspan>`;
      }
      if (valor === null || valor === undefined) {
        return `N/D <tspan style="cursor:help;"><title>Dado indispon├¡vel</title>Ôôÿ</tspan>`;
      }
      let icon = '';
      if (aviso === 'possivel_reset_medidor') {
        icon = ` <tspan style="cursor:help;"><title>leitura inst├ível (poss├¡vel reset de medidor)</title>ÔÜá´©Å</tspan>`;
      }
    ...
    /* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Mapeamento potencia -> velocidade da seta ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    ...
    /* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Aplicacao do estado visual de UM fluxo ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    ...
    /* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Atualiza badges de qualidade (4 dots) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    ...
    /* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Atualiza cor do "idade" conforme criticidade ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    ...
    /* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Aplicacao principal: payload -> DOM ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    function aplicarDados(p) {
      ...
      if (p.vazio) {
        log('payload vazio');
        if (refs.idade) {
          refs.idade.textContent = 'ÔÇö sem dados ÔÇö';
      ...
      // ÔöÇÔöÇ Valores numericos e Hibridos ÔöÇÔöÇ
      ...
      if (refs.bateriaDia) refs.bateriaDia.textContent = 'ÔÇö kWh';
      if (refs.bateria) refs.bateria.textContent = 'STANDBY';

      // ÔöÇÔöÇ Fluxos (velocidade + on/off independentes) ÔöÇÔöÇ
      ...
      // ÔöÇÔöÇ Qualidade (dots) ÔöÇÔöÇ
      atualizarQualidade(q.score);

      // ÔöÇÔöÇ Rodape ÔöÇÔöÇ
      ...
      // ÔöÇÔöÇ Guarda timestamp para tick de idade ÔöÇÔöÇ
      state.ultimoTsUtc = p.timestamp_utc || null;
      // idade_segundos vem do servidor ÔÇö usa como base inicial
    ...
    /* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Marca estado de erro ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    function marcaErro(motivo) {
      state.tentativasFalha++;
      warn(`erro fetch (${state.tentativasFalha}/${CFG.maxRetries}): ${motivo}`);
      // NAO zera valores ÔÇö mantem ultimo bom estado
    ...
    /* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Fetch principal ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    async function fetchDados() {
      if (state.pausado) {
        log('pausado (aba em background) ÔÇö fetch ignorado');
        return;
      }
    ...
    /* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Tick de idade (local, 1s) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    function tickIdade() {
    ...
    /* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Pausa quando aba sai de foco ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    ...
    /* ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ Bootstrap ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
    function iniciar() {
      log('iniciando ÔÇö endpoint:', CFG.endpoint, '| poll:', CFG.intervaloPoll + 'ms');
